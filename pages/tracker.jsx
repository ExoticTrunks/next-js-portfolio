...
import trackerImg from '../public/assets/covid-tracker.png';
...
const tracker = () => {
    ...
    <div className='w-full'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
            <h2 className='py-2'>Covid-19 Tracker App</h2>
            <h3>Vue JS / Tailwind / Firebase</h3>
        </div>
        </div>
        ...
        This application was built using the Covid 19 API.
        </p>
        <a
            href='https://github.com/ExoticTrunks/CovidTracker'
            target='_blank'
            rel='noreferrer'
        >
        ...
        <a
            href='https://covid-tracker-b0313.web.app/'
            target='_blank'
            rel='noreferrer'
        >
        ...
        <div className='p-2'>
            ...
            <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-1' /> Covid 19 API
            </p>
            </div>
        </div>
        </div>
